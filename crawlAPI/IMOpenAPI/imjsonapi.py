...
def createActionURL(appKey,actionInfos):
    ...
    base_url='http://cp.book.qq.com/ServiceBus.do?service=CpNovel&appKey=%s&appToken=%s'
    url=base_url%(appKey,appToken)+url_para
    print url
    url='http://untest.book.qq.com/ServiceBus.do?service=CpNovel&action=booklist&appKey=b7f7a2f01203&appToken=cef444e8dc47'
# http://cp.book.qq.com/ServiceBus.do?service=CpNovel&action=booklist&appKey=xxxxxxxxxx &appToken=xxxxxxxxxx
